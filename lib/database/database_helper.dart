...
class DatabaseHelper {
  static final _databaseName = "teledax.db";
  static final _databaseVersion = 1;
  static final table = 'apis';
  static final columnId = '_id';
  static final columnName = 'url';
  ...
  Future getById({@required id}) async {
    Database db = await instance.database;
...
// Delete By ID returns total deleted rows count
